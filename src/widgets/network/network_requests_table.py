...
class NetworkRequestsTable(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.requestsTable.setVerticalScrollMode(
            QAbstractItemView.ScrollPerPixel)
        self.ui.requestsTable.setHorizontalScrollMode(
            QAbstractItemView.ScrollPerPixel)
        ...
        self.ui.requestsTable.hover_index_changed.connect(
            delegate.highlight_index)
        ...
        self.ui.displayFiltersButton.clicked.connect(
            lambda: self.network_display_filters.show())
        self.ui.captureFiltersButton.clicked.connect(
            lambda: self.network_capture_filters.show())

        # Set row selection behaviour:
        self.ui.requestsTable.setSelectionBehavior(
    ...
    def setTableModel(self, model):
        ...
        self.ui.requestsTable.selectionModel().selectionChanged.connect(
            self.set_selected_requests)
    ...
    def set_selected_requests(self, selected, deselected):
        ...
        self.selected_request_ids = list(
            map(lambda index: index.data(), selected_q_indexes))
