# Form implementation generated from reading ui file 'src/ui/views/shared/encoders_popup.ui'
#
...
class Ui_EncodersPopup(object):
    def setupUi(self, EncodersPopup):
        ...
        self.hashersLayout = QtWidgets.QVBoxLayout(self.tab_2)
        self.hashersLayout.setContentsMargins(0, 10, 0, 0)
        self.hashersLayout.setObjectName("hashersLayout")
