# Form implementation generated from reading ui file 'src/ui/views/shared/flow_view.ui'
#
...
class Ui_FlowView(object):
    def setupUi(self, FlowView):
        ...
        self.requestStackedWidget = QtWidgets.QStackedWidget(self.splitter)
        self.requestStackedWidget.setObjectName("requestStackedWidget")
        self.requestTabs = QtWidgets.QTabWidget()
        ...
        self.requestStackedWidget.addWidget(self.requestTabs)
        ...
        self.responseBodyStack = QtWidgets.QStackedWidget(self.responseBodyRawTab)
        self.responseBodyStack.setObjectName("responseBodyStack")
        self.responseRaw = CodeEditor()
        self.responseRaw.setObjectName("responseRaw")
        self.responseBodyStack.addWidget(self.responseRaw)
        self.responseImg = QtWidgets.QLabel()
        self.responseImg.setObjectName("responseImg")
        self.responseBodyStack.addWidget(self.responseImg)
        self.verticalLayout_4_body.addWidget(self.responseBodyStack)
