# Form implementation generated from reading ui file 'src/ui/views/editor/fuzz_view.ui'
#
...
class Ui_FuzzView(object):
    def setupUi(self, FuzzView):
        FuzzView.setObjectName("FuzzView")
        FuzzView.resize(658, 678)
        self.verticalLayout = QtWidgets.QVBoxLayout(FuzzView)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.stackedWidget = QtWidgets.QStackedWidget(FuzzView)
        ...
        QtCore.QMetaObject.connectSlotsByName(FuzzView)

    def retranslateUi(self, FuzzView):
        _translate = QtCore.QCoreApplication.translate
        FuzzView.setWindowTitle(_translate("FuzzView", "Form"))
        self.requestTabs.setTabText(self.requestTabs.indexOf(self.requestHeadersTab), _translate("FuzzView", "Request"))
        self.requestTabs.setTabText(self.requestTabs.indexOf(self.requestBodyTab), _translate("FuzzView", "Body"))
        self.label.setText(_translate("FuzzView", "Payloads"))
        self.addPayloadButton.setText(_translate("FuzzView", "Import Payload"))
        self.label_2.setText(_translate("FuzzView", "Fuzzing Type"))
        self.label_3.setText(_translate("FuzzView", "Delay Type"))
        self.label_4.setText(_translate("FuzzView", "Delay Duration (s)"))
