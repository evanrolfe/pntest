# Form implementation generated from reading ui file 'src/ui/views/clients/clients_page.ui'
#
...
class Ui_ClientsPage(object):
    def setupUi(self, ClientsPage):
        ...
        self.anythingButton.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.gridLayout.addWidget(self.anythingButton, 0, 4, 1, 1)
        self.chromeButton = QtWidgets.QPushButton(ClientsPage)
        self.chromeButton.setEnabled(False)
        self.chromeButton.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.firefoxButton.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.chromiumButton.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.dockerButton = QtWidgets.QPushButton(ClientsPage)
        self.dockerButton.setEnabled(False)
        self.dockerButton.setMinimumSize(QtCore.QSize(0, 50))
        self.dockerButton.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.dockerButton.setObjectName("dockerButton")
        self.gridLayout.addWidget(self.dockerButton, 0, 3, 1, 1)
