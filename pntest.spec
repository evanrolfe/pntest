...
a = Analysis(['src/__main__.py'],
             ...
             binaries=[('include/pntest_proxy', 'include/'), ('include/cert9.db', 'include/'), ('include/rootCA.csr', 'include/'), ('include/rootCA.key', 'include/'), ('include/mitmproxy-ca.pem', 'include/'), ('include/mitmproxy-dhparam.pem', 'include/'), ('include/html_page.html', 'include/')],
